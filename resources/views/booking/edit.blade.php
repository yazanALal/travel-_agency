        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <select id="customer" name="customer_id" class="form-control">
                    <option  selected value="{{ $booking->customer->id }}">{{$booking->customer->name}}</option>
            ...
            <div class="form-group">
                ...
                <select id="ticket" name="ticket_id" class="form-control">
                    <option  selected value="{{ $booking->ticket->id }}">Go date {{ $booking->ticket->date_s }},Back date {{ $booking->ticket->date_e }},Company {{ $booking->ticket->company->name }}</option>
            ...
            <div class="form-group">
                ...
                <select id="select-city" name="hotel_id" class="form-control">
                    <option  selected value="{{ $booking->hotel->id }}">{{$booking->hotel->name}}</option>
                    @foreach ($cities as $city)
